        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
					...
					<input type="text" name="nombre" placeholder="Nombre del Producto" value= "<?php echo $nombre; ?>" class="form-control" required>
				</div>
				<div class="form-group">
					<label>Descripción</label>
					<input type="text" name="descripcion" placeholder="Descripción del Producto" value= "<?php echo $descripcion; ?>"class="form-control" required>
				</div>
				<div class="form-group">
					<label>Precio</label>

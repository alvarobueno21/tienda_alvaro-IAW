...
<html>
    <head>
        <title>G4mingforall</title>
        <?php include "./inc/links.php"; ?>        
    </head>
    <body>   
        <?php include "./inc/navbarlogged.php"; ?>
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header">
                <h1 class="animated lightSpeedIn">G4mingforall <small>Cádiz</small></h1>
                <span class="label label-danger">Tienda en Cádiz y Málaga</span>
        ...
        <?php
            if(isset($_GET['view'])){
                $content=$_GET['view'];
                $WhiteList=["index","produsuario","soporte","ticket","ticketcon","registro","configuracion"];
